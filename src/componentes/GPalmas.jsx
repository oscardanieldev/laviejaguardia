...
const GPalmas = () => {
    return ( 
        <Fragment>
            <div className="bg-palmas">
                <div className="container">
                    <div className="row">
                        <div className="col s12">
                            <h3 className="center-align sucursal-mt color-crema">Las Palmas</h3>
                        </div>
                    </div>
                    <div className="row "> 
                        <div className="col s12 l6 m-gimnasios borde-gimnasios sucursal center-align ">
                            <div className="p-3">
                        ...
                        <div className="col s12 l6 m-gimnasios sucursal-borde contenedor-iframe sucursal-borde-r">
