        ...
        <Fragment>
            <div className="bg-contacto">
                <div className="container">
                    <div className="row ">
                        <div className="col s12 l6 m-reservatu">
                        ...
                        <div className="col s12 l6 m-mapa center-align contenedor-iframe ">
                            <iframe className="iframe-responsivo" src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d120361.83640381071!2d-99.27206089547782!3d19.485406671840995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sa%20vijea%20guardia!5e0!3m2!1ses!2smx!4v1604099236548!5m2!1ses!2smx" width="550" height="350" frameborder="0" className="mapa" allowfullscreen="" aria-hidden="false" tabindex="0">
                            </iframe>
                        </div>
                    </div>
                </div>
